  ...
  return (
    <div className="min-h-screen flex flex-col p-4 sm:p-8">
      ...
      <div className="flex-1 flex flex-col items-center justify-center">
        ...
        >
          <h2 className="text-3xl sm:text-5xl font-bold bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 bg-clip-text text-transparent mb-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl w-full">
        {personas.map((persona, index) => (
          <motion.div
            ...
            whileHover={{ 
              scale: persona.comingSoon ? 1 : 1.05,
              transition: { duration: 0.2 }
            }}
            whileTap={{ scale: persona.comingSoon ? 1 : 0.95 }}
            className={`group ${persona.comingSoon ? 'cursor-not-allowed' : 'cursor-pointer'}`}
            onClick={() => !persona.comingSoon && onSelectPersona(persona)}
          >
            <div className={`
